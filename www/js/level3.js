...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Function to generate random numbers for multiplication based on the level
    function generateNumbers() {
        const maxNumber = 10 + level * 10; // Adjust the range based on the level
    ...
    // Function to check the user's answer for multiplication
    ...
    // Initialize the game with multiplication
    generateNumbers();
    updateDisplay();
});